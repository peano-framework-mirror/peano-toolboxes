...
tarch::logging::Log matrixfree::solver::SurplusCalculator::_log( "matrixfree::solver::SurplusCalculator" );


std::string matrixfree::solver::SurplusCalculator::toString( const Action& action ) {
  switch (action) {
    case Refine:
      return "Refine";
    case Delete:
...
matrixfree::solver::SurplusCalculator::SurplusCalculator(const SurplusCalculator& otherCalculator):
...
void matrixfree::solver::SurplusCalculator::mergeWithSurplusCalculatorFromOtherThread(const SurplusCalculator& otherCalculator) {
...
matrixfree::solver::SurplusCalculator::SurplusCalculator (
  ...
  tarch::la::Vector<3,double> meanValueStencil = matrixfree::stencil::StencilFactory::get1DMeanValueStencil();
  tarch::la::Vector<3,double> massStencil      = matrixfree::stencil::StencilFactory::get1DMassStencilWithoutHScaling();
...
void matrixfree::solver::SurplusCalculator::rescaleSurplusMaximum() {
...
double matrixfree::solver::SurplusCalculator::getBinOffset(int bin) const {
  return static_cast<double>(bin) * getBinSize();
}



void matrixfree::solver::SurplusCalculator::clearMeasurements(double minimumSurplus) {
...
void matrixfree::solver::SurplusCalculator::logStatistics(double minimumSurplus) const {
  int refineBins = 0;
  int deleteBins = 0;
  for (int i=0; i<_numberOfBins; i++) {
...
std::string matrixfree::solver::SurplusCalculator::Bin::toString() const {
  std::ostringstream msg;
  msg << "(#fits=" << _numberOfEntries
      << ",#cancels=" << _numberOfCancelledActions
      << ",action=" << matrixfree::solver::SurplusCalculator::toString(_associatedAction)
      << ")";
  return msg.str();
}
...
matrixfree::solver::SurplusCalculator::getNewLinearSurplus(
...
double matrixfree::solver::SurplusCalculator::getBinSize() const {
  return _surplusMaximumOnFineGrid / static_cast<double>(_numberOfBins);
}


int matrixfree::solver::SurplusCalculator::getBin(double surplus) const {
  int bin;
...
matrixfree::solver::SurplusCalculator::Action matrixfree::solver::SurplusCalculator::analyse(
...
tarch::la::Vector<TWO_POWER_D_TIMES_D,double> matrixfree::solver::SurplusCalculator::getLinearSurplusContributionFromFineGrid(
...
void matrixfree::solver::SurplusCalculator::setMinMaxMeshWidth( double minimumMeshSize, double maximumMeshSize ) {
...
double matrixfree::solver::SurplusCalculator::getMaximumMeshWidth() const {
